 ...
 * <ul>
 *   <li>{@link org.xtext.unq.planificador.pdm.impl.SemestreImpl#getAnho <em>Anho</em>}</li>
 *   <li>{@link org.xtext.unq.planificador.pdm.impl.SemestreImpl#getNumero <em>Numero</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SemestreImpl extends MinimalEObjectImpl.Container implements Semestre
{
  ...
  {
    return PdmPackage.Literals.SEMESTRE;
  }
  ...
  public void setAnho(int newAnho)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PdmPackage.SEMESTRE__ANHO, oldAnho, anho));
  }
  ...
  public void setNumero(int newNumero)
  {
    ...
    numero = newNumero;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PdmPackage.SEMESTRE__NUMERO, oldNumero, numero));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PdmPackage.SEMESTRE__ANHO:
        return getAnho();
      case PdmPackage.SEMESTRE__NUMERO:
        return getNumero();
    }
