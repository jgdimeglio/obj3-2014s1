 ...
 * <ul>
 *   <li>{@link org.xtext.unq.planificador.pdm.impl.DiaImpl#getDia <em>Dia</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DiaImpl extends MinimalEObjectImpl.Container implements Dia
{
  ...
  {
    return PdmPackage.Literals.DIA;
  }
  ...
  public EList<String> getDia()
  {
    if (dia == null)
    {
      dia = new EDataTypeEList<String>(String.class, this, PdmPackage.DIA__DIA);
    }
    return dia;
  }
