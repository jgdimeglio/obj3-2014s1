 ...
 * <ul>
 *   <li>{@link org.xtext.unq.planificador.pdm.Planificacion#getSemestre <em>Semestre</em>}</li>
 *   <li>{@link org.xtext.unq.planificador.pdm.Planificacion#getMaterias <em>Materias</em>}</li>
 *   <li>{@link org.xtext.unq.planificador.pdm.Planificacion#getHorarios <em>Horarios</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.unq.planificador.pdm.PdmPackage#getPlanificacion()
 * @model
 * @generated
 */
public interface Planificacion extends EObject
{
   ...
   * @see org.xtext.unq.planificador.pdm.PdmPackage#getPlanificacion_Semestre()
  ...
  /**
   * Sets the value of the '{@link org.xtext.unq.planificador.pdm.Planificacion#getSemestre <em>Semestre</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.unq.planificador.pdm.PdmPackage#getPlanificacion_Materias()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.xtext.unq.planificador.pdm.PdmPackage#getPlanificacion_Horarios()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.unq.planificador.pdm.Planificacion#getHorarios <em>Horarios</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
