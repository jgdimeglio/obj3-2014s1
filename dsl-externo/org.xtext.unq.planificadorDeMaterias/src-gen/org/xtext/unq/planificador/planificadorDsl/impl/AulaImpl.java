 ...
 * <ul>
 *   <li>{@link org.xtext.unq.planificador.planificadorDsl.impl.AulaImpl#getNombre <em>Nombre</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AulaImpl extends MinimalEObjectImpl.Container implements Aula
{
  ...
  {
    return PlanificadorDslPackage.Literals.AULA;
  }
  ...
  public EList<String> getNombre()
  {
    if (nombre == null)
    {
      nombre = new EDataTypeEList<String>(String.class, this, PlanificadorDslPackage.AULA__NOMBRE);
    }
    return nombre;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PlanificadorDslPackage.AULA__NOMBRE:
        return getNombre();
    }
