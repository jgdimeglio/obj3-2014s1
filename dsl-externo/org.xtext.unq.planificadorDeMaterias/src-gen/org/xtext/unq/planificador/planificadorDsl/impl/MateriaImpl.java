 ...
 * <ul>
 *   <li>{@link org.xtext.unq.planificador.planificadorDsl.impl.MateriaImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link org.xtext.unq.planificador.planificadorDsl.impl.MateriaImpl#getCargaHoraria <em>Carga Horaria</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MateriaImpl extends MinimalEObjectImpl.Container implements Materia
{
  ...
  {
    return PlanificadorDslPackage.Literals.MATERIA;
  }
  ...
  public void setNombre(String newNombre)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PlanificadorDslPackage.MATERIA__NOMBRE, oldNombre, nombre));
  }
  ...
  public NotificationChain basicSetCargaHoraria(CargaHoraria newCargaHoraria, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PlanificadorDslPackage.MATERIA__CARGA_HORARIA, oldCargaHoraria, newCargaHoraria);
  ...
  public void setCargaHoraria(CargaHoraria newCargaHoraria)
  {
    if (newCargaHoraria != cargaHoraria)
    {
      ...
      if (cargaHoraria != null)
        msgs = ((InternalEObject)cargaHoraria).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PlanificadorDslPackage.MATERIA__CARGA_HORARIA, null, msgs);
      if (newCargaHoraria != null)
        msgs = ((InternalEObject)newCargaHoraria).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PlanificadorDslPackage.MATERIA__CARGA_HORARIA, null, msgs);
      msgs = basicSetCargaHoraria(newCargaHoraria, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PlanificadorDslPackage.MATERIA__CARGA_HORARIA, newCargaHoraria, newCargaHoraria));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PlanificadorDslPackage.MATERIA__CARGA_HORARIA:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PlanificadorDslPackage.MATERIA__NOMBRE:
        return getNombre();
      case PlanificadorDslPackage.MATERIA__CARGA_HORARIA:
