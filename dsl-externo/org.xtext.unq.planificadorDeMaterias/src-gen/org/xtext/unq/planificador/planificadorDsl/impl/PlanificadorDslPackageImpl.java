...
import org.xtext.unq.planificador.planificadorDsl.PlanificadorDslFactory;
 ...
 * @generated
 */
public class PlanificadorDslPackageImpl extends EPackageImpl implements PlanificadorDslPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.unq.planificador.planificadorDsl.PlanificadorDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private PlanificadorDslPackageImpl()
  {
    super(eNS_URI, PlanificadorDslFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link PlanificadorDslPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static PlanificadorDslPackage init()
  {
    if (isInited) return (PlanificadorDslPackage)EPackage.Registry.INSTANCE.getEPackage(PlanificadorDslPackage.eNS_URI);

    // Obtain or create and register package
    PlanificadorDslPackageImpl thePlanificadorDslPackage = (PlanificadorDslPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PlanificadorDslPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PlanificadorDslPackageImpl());

    isInited = true;

    // Create package meta-data objects
    thePlanificadorDslPackage.createPackageContents();

    // Initialize created meta-data
    thePlanificadorDslPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    thePlanificadorDslPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(PlanificadorDslPackage.eNS_URI, thePlanificadorDslPackage);
    return thePlanificadorDslPackage;
  }
   ...
   * @generated
   */
  public PlanificadorDslFactory getPlanificadorDslFactory()
  {
    return (PlanificadorDslFactory)getEFactoryInstance();
  }
