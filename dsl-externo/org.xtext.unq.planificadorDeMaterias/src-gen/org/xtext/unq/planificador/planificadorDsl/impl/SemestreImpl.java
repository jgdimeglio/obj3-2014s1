 ...
 * <ul>
 *   <li>{@link org.xtext.unq.planificador.planificadorDsl.impl.SemestreImpl#getAnho <em>Anho</em>}</li>
 *   <li>{@link org.xtext.unq.planificador.planificadorDsl.impl.SemestreImpl#getNumero <em>Numero</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SemestreImpl extends MinimalEObjectImpl.Container implements Semestre
{
  ...
  {
    return PlanificadorDslPackage.Literals.SEMESTRE;
  }
  ...
  public void setAnho(int newAnho)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PlanificadorDslPackage.SEMESTRE__ANHO, oldAnho, anho));
  }
  ...
  public void setNumero(int newNumero)
  {
    ...
    numero = newNumero;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PlanificadorDslPackage.SEMESTRE__NUMERO, oldNumero, numero));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PlanificadorDslPackage.SEMESTRE__ANHO:
        return getAnho();
      case PlanificadorDslPackage.SEMESTRE__NUMERO:
        return getNumero();
    }
