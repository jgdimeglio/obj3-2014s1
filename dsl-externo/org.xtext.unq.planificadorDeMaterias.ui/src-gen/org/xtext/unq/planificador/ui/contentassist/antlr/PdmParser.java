		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSEMIAccess().getGroup(), "rule__SEMI__Group__0");
					put(grammarAccess.getEXCLUSIVAAccess().getGroup(), "rule__EXCLUSIVA__Group__0");
					put(grammarAccess.getMateriaAccess().getGroup(), "rule__Materia__Group__0");
					put(grammarAccess.getMateriaAccess().getGroup_4(), "rule__Materia__Group_4__0");
					put(grammarAccess.getAulaAccess().getGroup(), "rule__Aula__Group__0");
					put(grammarAccess.getAulaAccess().getGroup_2(), "rule__Aula__Group_2__0");
					...
					put(grammarAccess.getLunesAccess().getGroup(), "rule__Lunes__Group__0");
					put(grammarAccess.getMartesAccess().getGroup(), "rule__Martes__Group__0");
					put(grammarAccess.getMiercolesAccess().getGroup(), "rule__Miercoles__Group__0");
					put(grammarAccess.getJuevesAccess().getGroup(), "rule__Jueves__Group__0");
					put(grammarAccess.getViernesAccess().getGroup(), "rule__Viernes__Group__0");
					put(grammarAccess.getSabadoAccess().getGroup(), "rule__Sabado__Group__0");
					put(grammarAccess.getDiasAccess().getGroup(), "rule__Dias__Group__0");
					put(grammarAccess.getDiasAccess().getGroup_1(), "rule__Dias__Group_1__0");
					...
					put(grammarAccess.getModelAccess().getProfesorsAssignment_1(), "rule__Model__ProfesorsAssignment_1");
					put(grammarAccess.getModelAccess().getHorasAssignment_2(), "rule__Model__HorasAssignment_2");
					put(grammarAccess.getModelAccess().getMateriasAssignment_3(), "rule__Model__MateriasAssignment_3");
					put(grammarAccess.getModelAccess().getAulasAssignment_4(), "rule__Model__AulasAssignment_4");
					put(grammarAccess.getModelAccess().getCargasHorariasAssignment_5(), "rule__Model__CargasHorariasAssignment_5");
					put(grammarAccess.getModelAccess().getCargasHorariasDocentesAssignment_6(), "rule__Model__CargasHorariasDocentesAssignment_6");
					put(grammarAccess.getModelAccess().getHorariosAssignment_7(), "rule__Model__HorariosAssignment_7");
					put(grammarAccess.getModelAccess().getDiasAssignment_8(), "rule__Model__DiasAssignment_8");
					put(grammarAccess.getModelAccess().getSemestreAssignment_9(), "rule__Model__SemestreAssignment_9");
					put(grammarAccess.getModelAccess().getPlanificacionesAssignment_10(), "rule__Model__PlanificacionesAssignment_10");
					put(grammarAccess.getModelAccess().getHorariosAssignment_11(), "rule__Model__HorariosAssignment_11");
					put(grammarAccess.getModelAccess().getRecursosAssignment_12(), "rule__Model__RecursosAssignment_12");
					...
					put(grammarAccess.getMateriaAccess().getRecursosAssignment_4_1(), "rule__Materia__RecursosAssignment_4_1");
					put(grammarAccess.getAulaAccess().getNameAssignment_1(), "rule__Aula__NameAssignment_1");
					put(grammarAccess.getAulaAccess().getRecursosAssignment_2_1(), "rule__Aula__RecursosAssignment_2_1");
					put(grammarAccess.getCargaHorariaAccess().getCantHorasAssignment_1(), "rule__CargaHoraria__CantHorasAssignment_1");
					put(grammarAccess.getCargaHorariaAccess().getDiasAssignment_3(), "rule__CargaHoraria__DiasAssignment_3");
					put(grammarAccess.getCargaHorariaDocenteAccess().getNameAssignment_0(), "rule__CargaHorariaDocente__NameAssignment_0");
					...
					put(grammarAccess.getDiasAccess().getDiaAssignment_0(), "rule__Dias__DiaAssignment_0");
					put(grammarAccess.getDiasAccess().getMateriaAssignment_1_0(), "rule__Dias__MateriaAssignment_1_0");
					put(grammarAccess.getDiasAccess().getHorarioAssignment_1_2(), "rule__Dias__HorarioAssignment_1_2");
					...
					put(grammarAccess.getRecursoAccess().getNameAssignment_1(), "rule__Recurso__NameAssignment_1");
