	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getElementosPrimariosAccess().getAlternatives(), "rule__ElementosPrimarios__Alternatives");
					put(grammarAccess.getElementosSecundariosAccess().getAlternatives(), "rule__ElementosSecundarios__Alternatives");
					...
					put(grammarAccess.getModelAccess().getElementosPrimariosAssignment_0(), "rule__Model__ElementosPrimariosAssignment_0");
					put(grammarAccess.getModelAccess().getElementosSecundariosAssignment_1(), "rule__Model__ElementosSecundariosAssignment_1");
					put(grammarAccess.getModelAccess().getPlanificacionAssignment_2(), "rule__Model__PlanificacionAssignment_2");
					...
					put(grammarAccess.getHorarioAccess().getDesdeAssignment_0(), "rule__Horario__DesdeAssignment_0");
					put(grammarAccess.getHorarioAccess().getHastaAssignment_2(), "rule__Horario__HastaAssignment_2");
					...
					put(grammarAccess.getAsignacionAccess().getAulaHorariosAssignment_4(), "rule__Asignacion__AulaHorariosAssignment_4");
					...
					put(grammarAccess.getPlanificacionAccess().getAsignacionesAssignment_4(), "rule__Planificacion__AsignacionesAssignment_4");
